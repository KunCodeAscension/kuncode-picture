package com.kuncode.kuncodepicturebackend.manager.websocket.disruptor;

import cn.hutool.json.JSONUtil;
import com.kuncode.kuncodepicturebackend.manager.websocket.PictureEditHandler;
    ...
    public void onEvent(PictureEditEvent pictureEditEvent) throws Exception {
        ...
        switch (pictureEditMessageTypeEnum) {
            ...
            default:
                ...
                pictureEditResponseMessage.setUser(UserVO.toUserVO(user));
