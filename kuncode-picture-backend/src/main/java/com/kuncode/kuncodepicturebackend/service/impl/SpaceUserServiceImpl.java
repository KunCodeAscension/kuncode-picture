...
import com.kuncode.kuncodepicturebackend.mapper.SpaceUserMapper;
...
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser> implements ISpaceUserService {
    ...
    public Long addSpaceUser(SpaceUserAddRequest spaceUserAddRequest) {
        ...
        ThrowUtils.throwIf(!space.getSpaceType().equals(SpaceTypeEnum.TEAM.getValue()),ErrorCode.PARAMS_ERROR,"私人空间禁止添加成员");
        // 数据库操作
    ...
    public List<SpaceUserVO> getSpaceUserVOList(List<SpaceUser> spaceUserList) {
        ...
        spaceUserVOList.forEach(spaceUserVO -> {
            ...
            spaceUserVO.setUser(UserVO.toUserVO(user));
            // 填充空间信息
            Space space = null;
